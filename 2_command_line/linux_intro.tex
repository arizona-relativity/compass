...
To change direcotry to be inside the \verb|COMPASS2026| directory we just made, type
...
\begin{verbatim}
/home/USERNAME/COMPASS2026/dir4/subdir/subsubdir
\end{verbatim}
...
For example, if we wanted to get back to COMPASS2026, we could type

\begin{verbatim}
cd /home/USERNAME/COMPASS2026
\end{verbatim}
...
\end{verbatim}
        ...
        Yet another way to do this is to first call \verb|cd| with no filepath. This takes you to the user directory, and then you can go back into \verb|COMPASS2026| as before
...
\end{verbatim}
        ...
        Use \verb|pwd| to make sure you're back in the \verb|COMPASS2026| folder now, as expected.
...
\begin{verbatim}
cd /home/USERNAME/COMPASS2026/dir4/subdir/subsubdir
\end{verbatim}
